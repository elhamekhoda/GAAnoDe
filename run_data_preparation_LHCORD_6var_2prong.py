...
np.save(os.path.join(args.outdir, 'innerdata_extrasig_train_6var.npy'), innerdata_extrasig_train)
np.save(os.path.join(args.outdir, 'innerdata_extrasig_val_6var.npy'), innerdata_extrasig_val)
